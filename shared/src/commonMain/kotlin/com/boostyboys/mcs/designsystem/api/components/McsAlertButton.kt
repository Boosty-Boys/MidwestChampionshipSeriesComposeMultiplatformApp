...
@Composable
fun McsAlertButtonAndroidDesktop(
    text: String,
    onClick: () -> Unit,
    modifier: Modifier,
    enabled: Boolean,
    ...
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            backgroundColor = McsTheme.colors.alert,
            disabledBackgroundColor = McsTheme.colors.surface.copy(alpha = 0.5f),
            contentColor = McsTheme.colors.onAlert,
